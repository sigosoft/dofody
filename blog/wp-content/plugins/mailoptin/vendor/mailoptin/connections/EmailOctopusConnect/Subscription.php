...
class Subscription extends AbstractEmailOctopusConnect
{
    ...
    public function is_double_optin()
    {
        ...
        $setting = $this->get_integration_data('EmailOctopusConnectConnect_enable_double_optin');

        $val = $setting === true;

        return apply_filters('mo_connections_emailoctopus_is_double_optin', $val, $optin_campaign_id);
    }
