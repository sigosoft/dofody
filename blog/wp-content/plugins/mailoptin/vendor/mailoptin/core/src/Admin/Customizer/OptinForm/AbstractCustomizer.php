...
class AbstractCustomizer
{
    ...
    {
        $defaults                    = [];
        $defaults['remove_branding'] = apply_filters('mo_optin_form_remove_branding_default', false, $this->customizer_defaults, $this->optin_campaign_type, $this->optin_campaign_class);
