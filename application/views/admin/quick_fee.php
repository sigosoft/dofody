            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title float-left">Manage quick consultation fee</h4>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <form class="form-horizontal" action="<?php echo site_url('admin/updateQuickFee');?>" method="post">
              <div class="form-group m-b-25">
                <div class="col-12">
                  <label for="select">Video call</label>
                  <input type="text" class="form-control" name="video_fee" id="video_fee">
                </div>
              </div>
              <div class="form-group m-b-25">
                <div class="col-12">
                  <label for="select">Audio fee</label>
                  <input type="text" class="form-control" name="audio_fee" id="audio_fee">
                </div>
              </div>
              <div class="form-group m-b-25">
                <div class="col-12">
                  <label for="select">Chat fee</label>
                  <input type="text" class="form-control" name="chat_fee" id="chat_fee">
                </div>
              </div>
