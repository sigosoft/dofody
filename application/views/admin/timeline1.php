                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="page-title-box">
                              ...
                              <button type="button" onclick="window.location='<?php echo site_url("admin/activate_user/".$doc->user_id.'/'.$doc->user_status);?>'" class="btn btn-primary float-right" name="button"><?php if($doc->user_status=='1'){ echo "Deactivate"; } else { echo "Activate"; } ?></button>
