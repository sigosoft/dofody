            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box">
                  <h4 class="page-title float-left">Delete requests</h4>
                    ...
                    <tbody>
                      <?php foreach ($requests as $request) { ?>
                        <tr>
                          ...
                          <td><button class="btn btn-link" onclick="window.location='<?php echo site_url("admin/deleteAccount/".$request->user_id);?>'"><i class="fa fa-trash" style="font-size: 20px;color:red;"></i></button></td>
                        </tr>
                      <?php } ?>
                    </tbody>
                  </table>
