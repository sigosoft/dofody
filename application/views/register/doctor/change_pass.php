                                ...
                                <div class="account-box">
                                    ...
                                    <div class="account-content">
                                            ...
                                            <div id="change-pass" style="display:none;">
                                              <form action="<?=site_url('register_doctor/forgot_password_change')?>" method="post" onsubmit="return check_pass();">
          ...
          if (mobile == '') {
            ...
            if (len != 10) {
              ...
              if (isNaN(mobile)) {
                ...
                $.ajax({
                  method: "POST",
                  url: "<?php echo site_url('register_doctor/forgot_the_password');?>",
                  dataType : "text",
                  data : { mobile : mobile },
