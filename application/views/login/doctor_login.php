                            ...
                            <div class="account-pages">
                                <div class="account-box">
                                    <div class="account-logo-box">
                                        ...
                                        <h6 class="text-uppercase text-center font-bold mt-4">doctor login</h6>
                                    </div>
                                    <div class="account-content">
                                        <form class="form-horizontal" method="post" action="<?=site_url('doctor_login/check')?>">

                                            <div class="form-group m-b-20 row">
                                                <div class="col-12">
                                                    <label for="emailaddress">Email address</label>
                                                    <input class="form-control" type="text" name="email" required="" placeholder="Enter your email address">
                                                </div>
                                            </div>
                                            <textarea id="token" class="form-control" style="display:none" name="token"></textarea>
                                            <div class="form-group row m-b-20">
                                                <div class="col-12">
                                                    <a href="<?=site_url('register-doctor/change-password')?>" class="text-muted pull-right"><small>Forgot your password?</small></a>
                                        ...
                                        <div class="row m-t-50">
                                            <div class="col-sm-12 text-center">
                                                <p class="text-muted">Don't have an account? <a href="<?=site_url('register-doctor')?>" class="text-dark m-l-5"><b>Register</b></a></p>
                                            </div>
                                        </div>
