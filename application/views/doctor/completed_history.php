                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><button type="button" class="btn btn-rounded btn-primary waves-effect waves-light" onclick="window.location='<?=site_url("doctor/completed_history_view/".$request->req_id)?>'">View</button></td>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="modal-footer">
              <button class="btn w-md btn-rounded btn-primary waves-effect waves-light" type="submit">Edit</button>
              <button type="button" class="btn w-md btn-rounded btn-primary waves-effect waves-light" data-dismiss="modal">Close</button>
            </div>
