                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div id="paymentSuccess" style="display : none; color : green; font-size:18px;" class="text-center">
                        Thank you , your payment was recieved.
                      </div>
                      <div class="form-group">
                        <button class="btn btn-outline-primary btn-rounded waves-light waves-effect w-md pull-right" type="submit">Send request</button>
                      </div>
                    </form>
                    </div>
                  </div>
          ...
          <div class="modal-body">
            <div class="row">
              <?php $i=0; foreach ($doctors as $doctor) { ?>
                <?php if ($doctor->document == '') {
                  $doctor->document = "uploads/profile/doctor.jpeg";
                } ?>
                <div class="col-md-4">
                  <div class="card-box table-responsive p-0">
                    <div class="box box-primary">
                      <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="<?=base_url() . $doctor->document?>" alt="User profile picture">
                        <h4 class="profile-username text-center"><?=$doctor->name?></h4>
                        <p class="text-muted text-center"><?=$doctor->stream?></p>
                        <p class="text-muted text-center"><?=$doctor->special?></p>
                        <p class="text-muted text-center"><?=$doctor->place?></p>
                        <table class="table table-bordered">
                          ...
                          <tbody>
                            <tr>
                              <td><?=$doctor->video_fee?></td>
                              <td><?=$doctor->audio_fee?></td>
                              <td><?=$doctor->chat_fee?></td>
                            </tr>
                          </tbody>
                        </table>
                        <button type="button" class="btn btn-default btn-block btn-sm" name="button" onclick="doctor_selected('<?=$doctor->user_id?>')">Select</button>
                      </div>
                    </div>
                    <div id="accordion">
                      <div class="card">
                          <div class="card-header" id="headingOne">
                              <h6 class="m-0">
                                  <a href="#collapse<?=$i?>" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="collapse<?=$i?>">
                                      View description <i class="mdi mdi-arrow-down-bold-circle pull-right"></i>
                                  </a>
                              </h6>
                          </div>
