          ...
          <div class="row">
            <div class="col-12">
                <div class="card-box table-responsive">
                  <form action="<?=site_url('patient/general_name_change')?>" method="post">
                  ...
                  <form action="<?=site_url('patient/general_name_change')?>" method="post" onsubmit="return checkEmailFormat();">
                ...
                <form action="<?=site_url('patient/general_name_change')?>" method="post" onsubmit="return checkOtp();">
                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-md-4 col-md-push-4">
                            ...
                            <div class="form-group">
                              <input type="password" class="form-control" name="password" id="ps1" required>
                            </div>
                            <label>Confirm password</label>
                            <div class="form-group">
                              <input type="password" class="form-control" id="ps2" required>
                            </div>
                ...
                <div id="delete-account-edit" style="display : none; background-color :#F2F3F3 ; padding-top : 5px;">
                  <form action="<?=site_url('patient/delete_req')?>" method="post">
                    <div class="row">
                      <div class="col-md-4 col-md-push-4">
      ...
      <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Are you sure?</p>
            <form action="<?=site_url("patient/generalChangePassword");?>" method="post">
  ...
  var otp='';
      ...
      if (mobile == '') {
        ...
        if (len != 10) {
          ...
          if (isNaN(mobile)) {
            ...
            $.ajax({
              method: "POST",
              url: "<?php echo site_url('patient/generalMobileChange');?>",
              dataType : "text",
              data : { mobile : mobile },
    ...
    function check_password()
    {
      ...
      if (pass1 == pass2) {
        ...
        $.ajax({
          method: "POST",
          url: "<?php echo site_url('patient/generalPasswordChange');?>",
          dataType : "text",
